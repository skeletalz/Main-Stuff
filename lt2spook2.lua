...
repeat wait() until workspace.TreeRegion and game.Players.LocalPlayer.Character;
...
syn.queue_on_teleport([[loadstring(game:HttpGet("https://raw.githubusercontent.com/skeletalz/Main-Stuff/master/lt2spook2.lua"))()]])
